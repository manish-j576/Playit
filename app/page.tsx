  ...
  return <div>
    ...
    <div className="flex flex-col min-h-screen bg-gray-950 text-white">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-b from-gray-950 via-gray-900 to-gray-950">
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px]">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">
                      ...
                      {[
                        ...
                        >
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <p className="font-medium text-white">{item.song}</p>
                              <p className="text-sm text-gray-400">{item.artist}</p>
                            </div>
                          </div>
                          <div className="flex items-center gap-2">
                            <span className="text-green-400 font-medium">{item.votes}</span>
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <Card className="bg-gray-900/50 border-gray-700">
                <CardHeader>
                  <div className="bg-gradient-to-r from-purple-600 to-pink-600 p-3 rounded-lg w-fit">
                    <ThumbsUp className="h-6 w-6 text-white" />
                  </div>
                  <CardTitle className="text-white">Democratic Voting</CardTitle>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">Simple. Social. Musical.</h2>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-3 lg:gap-12">
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <h3 className="text-xl font-bold text-white">1. Add Your Songs</h3>
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <h3 className="text-xl font-bold text-white">2. Vote & Engage</h3>
                <p className="text-gray-400">
              ...
              <div className="flex flex-col items-center space-y-4 text-center">
                ...
                <h3 className="text-xl font-bold text-white">3. Enjoy Together</h3>
                <p className="text-gray-400">
        ...
        {/* Community Stats */}
        <section id="community" className="w-full py-12 md:py-24 lg:py-32 bg-gray-900/50">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl text-white">
            ...
            <div className="mx-auto grid max-w-5xl items-center gap-6 py-12 lg:grid-cols-4 lg:gap-12">
              ...
              <div className="flex flex-col items-center space-y-2 text-center">
                ...
                <p className="text-gray-400">Songs Voted</p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  10K+
                </div>
                <p className="text-gray-400">Rooms Created</p>
              </div>
              <div className="flex flex-col items-center space-y-2 text-center">
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  24/7
                </div>
                <p className="text-gray-400">Music Playing</p>
              </div>
            </div>
          </div>
        </section>
        ...
        {/* CTA Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gradient-to-r from-purple-900/20 to-pink-900/20">
